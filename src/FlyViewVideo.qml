// =============================================================================
// FlyViewVideo.qml — Agrohawk GCS Override
// Based on upstream QGC v5.0.8 (Stable_V5.0) FlyViewVideo.qml
// Adds: FPV HUD overlay + toggle button
// =============================================================================
...
Item {
    ...
    // --- Agrohawk: FPV HUD state ---
    property string _fpvHudSettingsKey: "AgrohawkFpvHudVisible"
    property bool   _fpvHudVisible: QGroundControl.loadBoolGlobalSetting(_fpvHudSettingsKey, false)

    Timer {
        interval: 500; running: true; repeat: true
        onTriggered: _fpvHudVisible = QGroundControl.loadBoolGlobalSetting(_fpvHudSettingsKey, false)
    }
    ...
    // =========================================================================
    // Agrohawk: FPV HUD Overlay
    // =========================================================================
    Loader {
        anchors.fill: parent
        active: _fpvHudVisible && QGroundControl.multiVehicleManager.activeVehicle
        source: "FpvHud.qml"
        onLoaded: {
            item.vehicle = Qt.binding(function() { return QGroundControl.multiVehicleManager.activeVehicle })
        }
    }
